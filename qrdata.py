...
def getCapacity(version: int, ecLevel: int, mode: str) -> int:
    ...
    return _QR_CAPACITIES[version - 1][ecLevel - 1][modePosMap[mode]]
...
def getCCILength(version: int, mode: str) -> int:
    ...
    if (1 <= version <= 9):
        return _CCI_LENGTHS[0][modePosMap[mode]]
    elif (10 <= version <= 26):
        return _CCI_LENGTHS[1][modePosMap[mode]]
    elif (27 <= version <= 40):
        return _CCI_LENGTHS[2][modePosMap[mode]]
    else:
...
# QR code alignment pattern locations
# Structure: alignPosLocations[version-1]
# version: 1–40 (index 0 = version 1)
# Generated using Claude AI, from https://www.thonky.com/qr-code-tutorial/character-capacities
...
# QR code error correction info (using typed NamedTuple)
# Each entry: (totalDataCw, ecCwPerBlock, g1Blocks, g1CwEach, g2Blocks, g2CwEach)
# Generated using Claude AI, from https://www.thonky.com/qr-code-tutorial/character-capacities

class ECInfo(NamedTuple):
    '''
    Named tuple containing all the information regarding error correction 
...
if __name__ == '__main__':
    ...
    print(getCapacity(16, 3, '0010')) # → 470
    print(getCapacity(27, 2, '1000')) # → 692
    print(getECInfo(1, 1).totalDataCodewords)     # → 19
    print(getECInfo(40, 4).totalDataCodewords)    # → 1276
    print(getECInfo(22, 3).totalDataCodewords)    # → 568
